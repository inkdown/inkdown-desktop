...
export default function HomePage() {
  ...
  return (
    <>
      <TitleBar sidebarWidth={0} sidebarVisible={false} />
      
      <main className="theme-card w-full h-[100vh] flex flex-col items-center justify-center space-y-8 relative pt-8">
